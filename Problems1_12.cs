...
namespace LeetCode
{
    ...
    public class Solution9
    {
        ...
        {
            var str = x.ToString();
            return str.Select((v, i) => v == str[^(i + 1)]).All(e => e);
        }

        [Fact]
        public void IsPalindromeTest()
        {
            Assert.Equal(true, Solution9.IsPalindrome(121));
            Assert.Equal(false, Solution9.IsPalindrome(-121));
            Assert.Equal(false, Solution9.IsPalindrome(10));
            Assert.Equal(false, Solution9.IsPalindrome(-101));
        }
    }
    public class Solution10
    {
        ...
        public void IsPalindromeTest()
        {
            Assert.Equal(false, Solution10.IsMatch("mississippi", "mis*is*p*."));
            Assert.Equal(true, Solution10.IsMatch("aab", "c*a*b"));
        }
    }
    public class Solution11
    {
        ...
        public void IsPalindromeTest()
        {
            Assert.Equal(49, Solution11.MaxArea(new int[] { 1, 8, 6, 2, 5, 4, 8, 3, 7 }));
            Assert.Equal(1, Solution11.MaxArea(new int[] { 1, 1 }));
            Assert.Equal(2, Solution11.MaxArea(new int[] { 1, 2, 1 }));
        }
    }
    public class Solution12
    {
        ...
        {
            Assert.Equal("III", Solution12.IntToRoman(3));
            Assert.Equal("MCMXCIV", Solution12.IntToRoman(1994));
        }
    }
}
